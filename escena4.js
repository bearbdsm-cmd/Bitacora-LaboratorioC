...
function triggerTextoRez(n) {
  ...
  switch(n) {
    ...
    case 2:
      ...
      break;
    case 3:
      textoMostrar = "ASOCIACIONES MUSICALES:\n\nREZ INFINITE\n\nInspirado en Rez Infinite —un videojuego donde cada acción de quien juega genera capas de música y ritmos que repiten secuencias interactuando con el espectador—, quise crear un espacio donde las imágenes no fueran solo para mirar, sino para tocar.\n\nSe diseñó una matriz de 7 pasos por 4 canales independientes (Drums, Claps, Synth, Bass). Para garantizar la consistencia estética y que el instrumento fuera siempre armónico, tomé la decisión crítica de acotar el universo tonal forzando los valores de matiz cromático (0-360) a una Escala Pentatónica mediante funciones de módulo matemático. Con un solo click un botón inferior activa/reproduce la referencia del canal, y con el siguiente click limpia la pista (silencio), optimizando los tiempos de reacción en la performance. *(Registro interactivo 4.mp4 a la derecha)*";
      break;
    case 4:
      textoMostrar = "AUTOENTREVISTA (EL ACCIDENTE ALGORÍTMICO):\n\n— Mencionas que el software falló inesperadamente durante la presentación final. En el contexto de tu magíster, ¿cómo resignificas ese error y qué aprendizaje técnico o estético extraes?\n\n— En las artes mediales, el error revela la fragilidad del sistema. El Imagófono mutó de la síntesis melódica al procesamiento destructivo de samples en tiempo real, llevando el hardware al límite. Que el sistema colapsara me dejó una lección curatorial profunda: el diseño de interacción debe contemplar el accidente. Para el futuro, la resiliencia no es crear un código infalible, sino diseñar vías de escape algorítmicas que permitan abrazar el glitch en vivo como un elemento expresivo más de la improvisación.";
      break;
    case 5:
